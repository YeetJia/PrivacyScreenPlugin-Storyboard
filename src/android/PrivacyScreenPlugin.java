...
public class PrivacyScreenPlugin extends CordovaPlugin {
  ...
  /**
   * Shorter way to check value of "PrivacyScreenEnabledAndroidFlag" preference.
   */
  private boolean isPrivacyScreenEnabled () {
    return preferences.getBoolean("PrivacyScreenEnabledAndroidFlag", false);
  }
}
